...
headers = {
    ...
    'Cookie': 'anonymid=jbxt1sweqy9qxs; _r01_=1; _de=EFF6C4BFE8062CA9A8DA1F0D724762818ED172744450A224; depovince=GW; p=7d5a7d53c319f9f571aa5f75812546736; ap=251796516; ln_uact=wangyu3054@163.com; ln_hurl=http://hdn.xnimg.cn/photos/hdn321/20120102/0015/h_main_BXw0_7a8300022ac72f75.jpg; jebe_key=7d64dd11-e9f1-4ef9-a298-c0b697396041%7Ccc843828bb292f8c71cbd1588ed4e6b5%7C1526999742393%7C1%7C1526999744209; __utma=10481322.1689172147.1527001217.1527001217.1527001217.1; __utmz=10481322.1527001217.1.1.utmcsr=(direct)|utmccn=(direct)|utmcmd=(none); _ga=GA1.2.1689172147.1527001217; _gid=GA1.2.1554020109.1527019342; first_login_flag=1; t=b1a26f6151e515ee1126ef34721906f56; societyguester=b1a26f6151e515ee1126ef34721906f56; id=251796516; xnsid=72c8b90f; ver=7.0; ',
...
for album in album_json['albumList']['albumList']:
    ...
    if album_source_code.status_code == 200:
        ...
        while count < photo_count:
            photo_url = photo_url_prefix.replace('<user_id>', user_id).replace('<album_id>', album_id).replace('<page_number>', str(page_number)).replace('<page_size>', str(page_size))
