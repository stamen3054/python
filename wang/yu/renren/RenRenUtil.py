...
photo_url_prefix = 'http://photo.renren.com/photo/<user_id>/album-<album_id>/bypage/ajax/v7?page=<page_number>&pageSize\
                        =<page_size>'
...
headers = {
    ...
    'Cookie': 'anonymid=jbxt1sweqy9qxs; _r01_=1; _de=EFF6C4BFE8062CA9A8DA1F0D724762818ED172744450A224; depovince=GW; \
                jebecookies=ddb5fac5-9337-4edc-ad3c-c50ce11c5223|||||; ick_login=02600425-0332-4906-85ab-88ddaf9df7b2; \
                p=7d5a7d53c319f9f571aa5f75812546736; ap=251796516; first_login_flag=1; ln_uact=wangyu3054@163.com; \
                ln_hurl=http://hdn.xnimg.cn/photos/hdn321/20120102/0015/h_main_BXw0_7a8300022ac72f75.jpg; \
                t=7ef03541c785ade08f06849fc3079e856; societyguester=7ef03541c785ade08f06849fc3079e856; id=251796516; \
                xnsid=77b9157f; ver=7.0; loginfrom=null; \
                jebe_key=7d64dd11-e9f1-4ef9-a298-c0b697396041%7Ccc843828bb292f8c71cbd1588ed4e6b5%7C1526999742393%7C1%\
                7C1526999744209; wp_fold=0; JSESSIONID=abcB_cWWQsTbW-N3Wriow; __utma=10481322.1689172147.1527001217.\
                1527001217.1527001217.1; __utmc=10481322; __utmz=10481322.1527001217.1.1.utmcsr=(direct)|utmccn=\
                (direct)|utmcmd=(none)',
...
for album in album_json['albumList']['albumList']:
    ...
    if album_source_code.status_code == 200:
        ...
        photo_list_text = str(photo_list_script).split('nx.data.photo = ')[1]\
            .split(';\n; define.config(')[0]\
            .replace('\'', '"')
        ...
        while count < photo_count:
            photo_url = photo_url_prefix.replace('<user_id>', user_id)\
